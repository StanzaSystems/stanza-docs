# Configuring Stanza
Stanza Decorators, Services, and Features have extensive configuration options. This documentation site contains basic guidance. 
...
[Decorator Configuration:](/configuration/decorators.mdx)
...
The [Stanza API Demo](https://github.com/StanzaSystems/stanza-api-demo) is a robust walk-through of the capabilities of decorators and ways they can be configured including:
