...
Non-React user interfaces can get good value from the browser SDK, but if you are using React - use of the [React SDK](./react) is recommended.
...
A [Feature](/concepts#feature) is a capability of software and it's constituent traffic flow through backend services - like 'product search', 'checkout' or 'settings'

A [Context](/concepts#context) is a group of features that you would like to load, store and refresh together.
