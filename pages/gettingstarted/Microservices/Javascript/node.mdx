...
One of the main features of Stanza is the ability to guard the execution of your code by wrapping it with a decorator. If you want to learn more about what decorators are please read our [concepts](../concepts) page first.
...
If we want to guard this block of code with a Stanza decorator we can define a decorator first:
