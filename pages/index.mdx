...
Stanza makes user experience aware reliability tools. Stanza can help you do things like manage rate limits, prevent database overloads, or gracefully degrade a UI with clear messages - all in a way that puts user need first!

# Why Use Stanza?

We know, `User Experience Aware Reliability Tools` is kind of a mouthful! But Stanza solves a lot of common reliability problems in software today, in a way that most benefits the users of your software.
...
- Wanting to gracefully degrate user interfaces when underlying services like caches or database replicas have failed
